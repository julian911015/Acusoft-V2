...
<html dir="ltr" lang="en-US"><head><!-- Created by Artisteer v4.1.0.59861 -->
    ...
    #art-main .art-sheet.clearfix .art-layout-wrapper .art-content-layout .art-content-layout-row table tr td strong {
	font-size: 10px;
}
    </style>
                    ...
                    <div class="art-content-layout-row">
                        <div class="art-layout-cell art-content"><article class="art-post art-article">
                                <div class="art-postmetadataheader">
                                        <h2 class="art-postheader">Reporte Acudientes</h2>
                                                            
                          </div>
                          <div class="art-postcontent art-postcontent-0 clearfix"><p>&nbsp;</p>
                            <p>INFORMACION DE ACUDIENTES::</p>
                                  <p>&nbsp;</p>
...
<tr>
  <td width="20%"><strong>CODIGO NIÑO(A)</strong></td>
  <td width="12%"><strong>GRUPO</strong></td>
  <td width="15%"><strong>NOMBRE ACUDIENTE</strong></td>
  <td width="15%"><strong>APELLIDO ACUDIENTE</strong></td>
  <td width="15%"><strong>TELEFONO ACUDIENTE</strong></td>
  <td width="15%"><strong>DIRECCION ACUDIENTE</strong></td>
  <td width="15%"><strong>CORREO ACUDIENTE</strong></td>
 ...
 <?php
    ...
    while ( $row = mysql_fetch_array($result) )
    {
	  ...
	  ?><?php echo  "<tr>"; 
	  ?> <?php echo  "<td ><br>".$row['codigo']."</td>";
	  ?> <?php echo  "<td><br>".$row['grupo']."</td>";    
	  ?> <?php echo "<td><br>".$row['nombre']."</td>"; 
	  ?> <?php echo "<td><br>".$row['apellido']."</td>"; 
	  ?> <?php echo "<td><br>".$row['telefono']."</td>"; 
	  ?> <?php echo "<td><br>".$row['direccion']."</td>"; 
	  ?> <?php echo "<td><br>".$row['correo']."</td>"; 
	  ?> <?php echo  "</tr>"; 
	  ?>
                                    <?php
    }
    ...
    ?>
                                  ...
                                  &nbsp;</p>
                            <p>
                              <input type="button" onClick="window.location='reporte_PDF_acudientes.php'" value="Descargar en PDF" />
                      </p>
                            <p>                              <br>
                            </p>
                          </div>
                      <p><a href="reportes.php"> ATRAS</a></p>
                      <p>&nbsp;</p>
                          <p>&nbsp;</p>
                        </article></div>
