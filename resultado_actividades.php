                    ...
                    <div class="art-content-layout-row">
                        <div class="art-layout-cell art-content"><article class="art-post art-article">
                                <div class="art-postmetadataheader">
                                        <h2 class="art-postheader">Reporte Actividades</h2>
...
$query = "SELECT * FROM reporte_actividades WHERE fecha BETWEEN  '$_POST[fecha]' AND '$_POST[fecha2]' ORDER BY fecha" ;
...
<tr>
 ...
 <?php
    ...
    <p>
      <input type="button" onClick="window.location='reporte_PDF_actividades.php'" value="Descargar en PDF" />
    </p>
    <p>      <br>
    </p>
                          </div>
                          <p><a href="reporte_actividades.php">ATRAS</a></p>
                          <p>&nbsp;</p>
                          <p>&nbsp;</p>
                        </article></div>
