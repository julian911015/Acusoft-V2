<?php
   ...
   //Iniciar una sesion de PHP
    ...
    if(isset($_POST['Enviar'])) { // comprobamos que se hayan enviado los datos del formulario 
        // comprobamos que los campos usr y pw no estén vacíos 
...
<nav class="art-nav">
    ...
    <ul class="art-hmenu"><li><a href="inicio.php" class="">Inicio</a></li><li><a href="contactenos.php" >Contactenos</a></li><li><a href="gestion.php">Gestión</a><ul><li><a href="gestion/planeador-de-actividades.php">Planeador de Actividades</a></li><li><a href="gestion/diario-de-campo.php">Diario de Campo</a></li><li><a href="gestion/libro-de-novedades.php">Libro de Novedades</a></li><li><a href="gestion/formato-peso-y-talla.php">Formato Peso y Talla</a></li></ul></li><li><a href="seguimiento.php">Seguimiento</a></li></ul> 
        </div>
    </nav>
                    ...
                    <div class="art-content-layout-row">
                        <div class="art-layout-cell art-content"><article class="art-post art-article">
                                <div class="art-postmetadataheader">
                                        <h2 class="art-postheader"><span class="art-postheadericon">CAMPOS VACIOS</span></h2>
...
<p>&nbsp;</p>
<p>Los campos de usuario y Password estan vacios por favor reintente</p>
...
</span><span style="font-weight: bold;"><a href="inicio.php">Volver al inicio</a><br>
</span></p>
...
<ul class="art-vmenu"><li><a href="inicio.php" class="">Inicio</a></li><li><a href="contactenos.php" >Contactenos</a></li><li><a href="gestion.php">Gestión</a><ul><li><a href="gestion/planeador-de-actividades.php">Planeador de Actividades</a></li><li><a href="gestion/diario-de-campo.php">Diario de Campo</a></li><li><a href="gestion/libro-de-novedades.php">Libro de Novedades</a></li><li><a href="gestion/formato-peso-y-talla.php">Formato Peso y Talla</a></li></ul></li><li><a href="seguimiento.php">Seguimiento</a></li></ul>
...
<p>Línea ventas Cel: 318487335. Centro de Servicio: 3162282464</p><p><br></p>
    ...
    <p class="art-page-footer">
        <span id="art-footnote-links"><a href="http://www.artisteer.com/" target="_blank">Web Template</a> created with Artisteer.</span>
            ...
            $sql = mysql_query("SELECT user, nombre_user, clave FROM users WHERE user='".$usr."' AND clave='".$pw."'"); 
			
            if($row = mysql_fetch_array($sql)) 
			{ 
                
				
		 $_SESSION['user'] = $row['user']; // creamos la sesion "usuario_id" y le asignamos como valor el campo user 
		 
         $_SESSION['nombre_user'] = $row["nombre_user"]; // creamos la sesion "usuario_nombre" y le asignamos como valor el campo nombre_user
               ...
               echo" <SCRIPT LANGUAGE='javascript'>"
                 . "		location.href = 'gestion/planeador-de-actividades.php';"
                 . "		</SCRIPT>"
                 ."";
...
<div class="art-sheet clearfix">
            <div class="art-layout-wrapper">
                <div class="art-content-layout">
                    <div class="art-content-layout-row">
                        <div class="art-layout-cell art-content"><article class="art-post art-article">
                                <div class="art-postmetadataheader">
                                        <h2 class="art-postheader"><span class="art-postheadericon">ERROR DE AUTENTICACIÓN</span></h2>
    ...
    <div class="art-layout-cell layout-item-0" style="width: 100%" >
<p>&nbsp;</p>
<p>Los campos de usuario y Password NO son corrrectos por favor reintente</p>
<p><span style="color: rgb(84, 84, 84); font-family: arial, sans-serif; font-size: small; line-height: 18.200000762939453px; background-color: rgb(255, 255, 255);"><br>
</span><span style="font-weight: bold;"><a href="inicio.php">Volver al inicio</a><br>
<br>
</p>
