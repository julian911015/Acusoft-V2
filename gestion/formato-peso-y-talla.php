...
<html dir="ltr" lang="en-US"><head><!-- Created by Artisteer v4.1.0.59861 -->
    <meta charset="utf-8">
    <title>formato-peso-y-talla</title>
    ...
    <style type="text/css">
    #art-main .art-sheet.clearfix .art-layout-wrapper .art-content-layout .art-content-layout-row .art-layout-cell.art-content .art-post.art-article .art-postcontent.art-postcontent-0.clearfix form p label {
	text-align: left;
}
                ...
                <div class="art-content-layout">
                    <div class="art-content-layout-row">
                      ...
                      <div class="art-postmetadataheader">
                                        <h2 class="art-postheader"><span class="art-postheadericon">Formato Peso y Talla</span></h2>
                                                            
                                    </div>
                                <div class="art-postcontent art-postcontent-0 clearfix"><p>&nbsp;</p>
                                <p>De acuerdo a los siguientes graficos, por favor relacione cual es la estatura (cm) y la edad (meses) de cada niño.</p>
                                <p>&nbsp;</p>
                                  <p>
                      <form action="registro_peso_talla.php"  method="post" name="form"> 
</p>
...
?>
  ...
  <tr>
    ...
    <td height="40" colspan="2" bgcolor="#F1EFDC" class="titulo2">   <p>
      <label><span class="rojo">*</span>Codigo Estudiante:</label>
    </p></td>
  </tr>
  <tr>
...
<option value=""> Seleccione
  ...
  <tr>
    ...
    <td height="40" colspan="2" bgcolor="#F1EFDC"><input name="estatura" type="text" size="50" maxlength="50" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td height="40" colspan="2" bgcolor="#F1EFDC"><input name="peso" type="text" size="50" maxlength="50" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="270" >  <div align="center"><span class="titulo3">
      <input type="reset" value="Borrar"  class="boton"  /> 
                          ...
                          <p>&nbsp;</p>
                          <p>Tenga en cuenta los siguientes graficos para diligenciar la información.</p>
                          <p>&nbsp;</p>
                          <p></p>
                          <p>&nbsp;</p>
                          <p><img src="../images/formaPESO.png" width="529" height="325" alt="peso"><img src="../images/formalong.png" width="523" height="301" alt="estatura"></p>
                          <p>&nbsp;</p>
                          <p><br>
                          </p>
                          </div>
