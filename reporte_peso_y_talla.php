                ...
                <div class="art-content-layout">
                    <div class="art-content-layout-row">
                      ...
                      <div class="art-postmetadataheader">
                                        <h2 class="art-postheader">Reporte Peso y Talla</h2>
                          ...
                          <p>INFORMACION DE PESO Y TALLA PARA ESTUDIANTES:</p>
                                  <p>&nbsp;</p>
...
<tr>
  ...
  <td width="20%"><strong class="CENTRO" > <span class="italica">NOMBRE</span></strong></td>
  <td width="20%"><strong>APELLIDO</strong></td>
  <td width="12%"><strong>GRUPO</strong></td>
  <td width="18%"><strong>EDAD (Meses)</strong></td>
  <td width="13%"><strong>PESO (Kg)</strong></td>
  <td width="17%"><strong>ESTATURA (cm)</strong></td>
  </tr>
 <?php
    ...
    while ( $row = mysql_fetch_array($result) )
    {
	  ...
	  ?> <?php echo "<td><br>".$row['edad']."</td>"; 
	  ?> <?php echo "<td><br>".$row['peso']."</td>"; 
	  ?> <?php echo "<td><br>".$row['estatura']."</td>"; 
	  ?> <?php echo  "</tr>"; 
	  ?>
                                    <?php
    }
    ...
    ?>
                                  ...
                                  &nbsp;
                      <p>
                        <input type="button" onClick="window.location='reporte_PDF_peso_y_talla.php'" value="Descargar en PDF" />
                      </p>
                      <p>&nbsp;</p>
                      <p>                        <br>
                      </p>
