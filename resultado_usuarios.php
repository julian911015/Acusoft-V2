                    ...
                    <div class="art-content-layout-row">
                        <div class="art-layout-cell art-content"><article class="art-post art-article">
                                <div class="art-postmetadataheader">
                                        <h2 class="art-postheader">Reporte Estudiantes</h2>
...
<tr>
  <td width="15%"><strong class="CENTRO" > <span class="italica">CODIGO</span></strong></td>
  <td width="25%"><strong>NOMBRE</strong></td>
  <td width="26%"><strong>APELLIDO</strong></td>
  <td width="17%"><strong>GRUPO</strong></td>
  <td width="17%"><strong>EDAD (Meses)</strong></td>
 ...
 <?php
    ...
    ?>
                                  ...
                                  &nbsp;
                            <p>
                              <input type="button" onClick="window.location='reporte_PDF_estudiantes.php'" value="Descargar en PDF" />
                            </p>
                            <p>                              <br>
                            </p>
                          </div>
                          <p><a href="reportes.php">ATRAS</a>
                      </article></div>
